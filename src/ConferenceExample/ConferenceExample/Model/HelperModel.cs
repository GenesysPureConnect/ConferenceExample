...
using ININ.Alliances.Examples.ConferenceExample.Properties;
using ININ.Alliances.Examples.ConferenceExample.ViewModel;

namespace ININ.Alliances.Examples.ConferenceExample.Model
{
    public static class HelperModel
    {
        ...
        public static void LoadSettings(MainViewModel main)
        {
            try
            {
                ...
                main.CicStation = Settings.Default.CicStation;
            }
            catch (Exception ex)
            {
        ...
        public static void SaveSettings(MainViewModel main)
        {
            try
            {
                ...
                Settings.Default.CicStation = main.CicStation;
